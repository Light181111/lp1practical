...
public class Assembler_PassOne_V2 {
 ...
 static void pass1() throws Exception {
  BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("src/lp1/input.txt")));
  out_pass1 = new PrintWriter(new FileWriter("src/lp1/output_pass1.txt"), true);
  PrintWriter out_symtable = new PrintWriter(new FileWriter("src/lp1/symtable.txt"), true);
  PrintWriter out_littable = new PrintWriter(new FileWriter("src/lp1/littable.txt"), true);
  String s;
  // out_pass1.println("Swarup Kharat Roll No: 5");
  // out_symtable.println("Swarup Kharat Roll No: 5");
  // out_littable.println("Swarup Kharat Roll No: 5");
...
////  Read from input file one line at a time
 ...
 static void initializeTables() throws Exception {
  ...
  String s,mnemonic;
  BufferedReader br;
  br = new BufferedReader(new InputStreamReader(new FileInputStream("src/lp1/mot.txt")));
